// ABOUTME: Echo slot panel — three sliders (Time, Feedback, Mix). Debounce arrives in Chunk 3.
// ABOUTME: onChange is wired but the engine ignores echo params until Chunk 4 worklet lands.
