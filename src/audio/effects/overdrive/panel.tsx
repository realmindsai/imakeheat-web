// ABOUTME: Overdrive panel — Drive, Tone, Level, and Mix controls.
// ABOUTME: Matches existing slider-row pattern with debounced store updates.
...
export function OverdrivePanel({ slot, onChange }: Props) {
